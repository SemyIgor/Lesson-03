// Lesson-03_Seminar09_Task65. Print all positive integers in the range of M to N
...
void PrintIntegersOfRange() // Gets two positive integer numbers and prints them from min to max
{
   ...
   try
   {
      string arrayItemRangeStr = InputString("Укажите минимальное и максимальное значение по форме min-max: "); // Enter min and max using min - max form
